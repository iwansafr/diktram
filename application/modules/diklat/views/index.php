...
<div class="col-md-8">
	...
	$form->addInput('asl_sekolah','text');
	$form->setLabel('asl_sekolah', 'Asal Sekolah');

	$form->addInput('almt_sekolah','textarea');
	$form->setLabel('almt_sekolah', 'Alamat Sekolah Asal');
	$form->startCollapse('nama', 'Data Calon Siswa');
	$form->endCollapse('almt_sekolah');
